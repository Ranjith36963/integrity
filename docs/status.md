...
- **Branch:** `claude/build-dharma-pwa-8WVNB` at `18e737f` · `main` at `c3ef9f1` (feature branch not yet merged)
- **Last commit:** `18e737f` — `docs(ship-m0): release notes + status snapshot for m0`
