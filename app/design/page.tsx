...
export default function DesignPage() {
  return (
    <main>
      <h1 className="mb-6 font-mono [font-size:var(--fs-22)] text-[var(--ink)]">
      ...
      <section className="mt-12">
        <h2 className="mb-4 font-mono [font-size:var(--fs-14)] tracking-wider text-[var(--ink-dim)] uppercase">
          Token Contrast Pairs
        </h2>
        <div className="flex flex-col gap-2">
          <div
            style={{ color: "#f5f1e8", background: "#07090f" }}
            className="rounded p-3 font-mono [font-size:var(--fs-12)]"
          >
