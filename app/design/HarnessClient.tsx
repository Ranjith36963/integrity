...
export function HarnessClient() {
  ...
  return (
    <div className="flex flex-col gap-8">
      {/* ── Button ── */}
      <section>
        <h2 className="mb-3 font-mono [font-size:var(--fs-12)] tracking-wider text-[var(--ink-dim)] uppercase">
          Button
        </h2>
      ...
      <section>
        ...
        <Modal
          ...
          title="Modal Title"
        >
          <p className="mb-4 font-mono [font-size:var(--fs-14)] text-[var(--ink-dim)]">
            Modal body content
          </p>
